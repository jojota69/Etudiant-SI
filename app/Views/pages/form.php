...
<div class="page-header">
  ...
  <a href="/utilisateurs" class="btn btn-secondary btn-sm">
...
<div class="alert alert-info">
  ...
  <span>Les champs marques d'un <strong>*</strong> sont obligatoires. Ce formulaire illustre tous les types de champs disponibles dans le SI.</span>
</div>

<form onsubmit="return false">

  <div class="form-card section-gap">
    <div class="form-section-title">1. Identite &amp; coordonnees</div>
    <div class="form-grid">
      <div>
      ...
      <div>
        ...
        <input type="email" placeholder="utilisateur@etunote.mg" />
      </div>
      <div>
  ...
  <div class="form-card section-gap">
    <div class="form-section-title">2. Profil systeme</div>
    <div class="form-grid">
      <div>
        <label class="field-label">Matricule <span class="required">*</span></label>
        <input type="text" value="USR-0047" />
        <div class="field-hint">Genere automatiquement, modifiable.</div>
      </div>
      <div>
      ...
      <div>
        <label class="field-label">Heure de debut de session</label>
  ...
  <div class="form-card section-gap">
    <div class="form-section-title">3. Parametres numeriques</div>
    ...
    <div class="form-grid cols-1">
      <div>
        <label class="field-label">Niveau de priorite — <span id="range-label">50</span>%</label>
        ...
        <div class="field-hint">0 = tres basse priorite | 100 = critique</div>
      </div>
    </div>
  </div>

  <div class="form-card section-gap">
    <div class="form-section-title">4. Choix &amp; preferences</div>
    <div class="form-grid">
      <div>
  ...
  <div class="form-card section-gap">
    ...
    <div class="form-grid">
      <div style="display:flex;flex-direction:column;gap:14px">
        ...
        <div class="toggle-wrap">
          <label class="toggle"><input type="checkbox" checked /><span class="toggle-slider"></span></label>
          <span>Notifications e-mail activees</span>
        </div>
        <div class="toggle-wrap">
          <label class="toggle"><input type="checkbox" /><span class="toggle-slider"></span></label>
          <span>Authentification a deux facteurs (2FA)</span>
        </div>
        <div class="toggle-wrap">
          <label class="toggle"><input type="checkbox" /><span class="toggle-slider"></span></label>
          <span>Acces API externe autorise</span>
        </div>
        <div class="toggle-wrap">
          <label class="toggle"><input type="checkbox" checked /><span class="toggle-slider"></span></label>
          <span>Journal d'audit active</span>
        </div>
      </div>
      <div>
        ...
        <div>
          <label class="field-label">Evaluation initiale</label>
          ...
          <div class="field-hint">Competence initiale (1–5)</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-card section-gap">
    <div class="form-section-title">6. Informations complementaires &amp; pieces jointes</div>
    <div class="form-grid cols-1">
      <div>
        <label class="field-label">Biographie / Remarques</label>
        <textarea placeholder="Decrivez le profil de l'utilisateur, ses competences, ses remarques particulieres…"></textarea>
      </div>
    </div>
    <div class="form-grid">
      <div>
        ...
        <label for="file-photo" class="file-drop">
          ...
          <p>Deposez une image ici<br /><strong>ou cliquez pour parcourir</strong></p>
      ...
      <div>
        ...
        <label for="file-docs" class="file-drop">
          ...
          <p>Deposez vos fichiers ici<br /><strong>ou cliquez pour parcourir</strong></p>
